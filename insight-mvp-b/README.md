Disregard this stock README from the template that I am currently working off of for the prototype for now (which can be found in the folder insight-mvp-b).
